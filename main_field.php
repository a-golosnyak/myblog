        ...
        <div class="container data-field">
            <div class="row">
                <div class="col-sm-8 blog-main">
                    <div class="blog-post">
                        <h4 class="blog-post-title">Недорогой аудио фильтр подавляет шумы и фон</h4>
                        <p class="blog-post-meta">January 1, 2014 by <a href="#">Mark</a></p>

                        <p>Описанный в этой статье недорогой многозвенный пассивный фильтр не нуждается
                         в источнике питания и может улучшить характеристики аудио и измерительного 
                         оборудования, ослабляя сетевой фон и уровень паразитных сигналов вещательных 
                         станций АМ, FM и нижней части VHF диапазонов (Рисунок 1). Композитный фильтр
                          образован каскадным соединением трех простых фильтров: Т-образного фильтра 
                          верхних частот для ослабления фона источника питания и двух П-образных фильтров 
                          нижних частот для подавления паразитных радиочастотных сигналов. В варианте, 
                          показанном на схеме, эти три секции образуют не имеющий потерь фильтр Чебышева 
                          с пульсациями 0.01 дБ на нагрузке с входным импедансом 50 Ом, но при необходимости 
                          вы можете пересчитать параметры компонентов фильтра под другой импеданс.
                        </p>
  
                        <div class="image-wrapper">
                            <img src="images/posts/Fig_1_Rus.gif">
