                    ...
                    <div class="nav-item dropdown " style="left: auto; right: 0;">
                        ...
                        if ($userLoggedIn == true) 
                        {
                            echo    "<div class='media-middle nav-item'>
                                    ...
                                    <div class='nav-link dropdown-toggle nav-item offset-sm-0'data-toggle='dropdown'href='#'role='button'    aria-haspopup='true'aria-expanded='false'>
                                    </div>
                        ...
                        { 
                            echo    "<div class='nav-link dropdown-toggle' data-toggle='dropdown' href='#'' role='button'         aria-haspopup='true' aria-expanded='false'>Sign In</div>
                                        <div class='dropdown-menu dropdown-menu-right'>
                                            <div class='dropdown-item' href='#'>Action</div>
                                            <div class='dropdown-divider'></div>
                                            <div class='dropdown-item' href='#'>Another action</div>
